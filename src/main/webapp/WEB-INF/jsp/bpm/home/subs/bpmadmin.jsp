...
<table class="board_01" summary="BBS Article Control">
	...
	<thead>
		<tr>
			<th scope="col" width="7%">Number</th>
			<th scope="col" width="25%">제목</th>
			<th scope="col" width="13%">시작일</th>
			<th scope="col" width="8%">상태</th>
			<th scope="col" width="17%">단계</th>
			<th scope="col" width="8%">지연일</th>
		</tr>
	</thead>
	<tbody>
		<c:choose>
		...
		<tr>
			...
			<td class="center">${instance.state eq 'OPEN' ? '진행중' : (instance.state eq 'COMPLETED' ? '완료' : instance.state)}</td>
			<td class="center">${instance.activityName}</td>
		...
		<c:forEach var="lc" begin="${tc + 1}" end="9" step="1">
		...
		<c:otherwise>
		<tr class="table_padding"> 
			<td align="center" colspan="8">&nbsp; DATA 가 없습니다. &nbsp;</td>
		</tr>
		<c:forEach var="lc" begin="1" end="9" step="1">
		<tr class="table_padding"> 
			<td align="center" colspan="8">&nbsp;</td>
		</tr>
		</c:forEach>
